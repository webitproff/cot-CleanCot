 ...
 * Description: HTML template of the recentitems plugin - its main part with filters. This template includes templates of updated pages (news) recentitems.pages.tpl and forum updates - recentitems.forums.tpl

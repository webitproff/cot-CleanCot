<!-- BEGIN: MAIN -->
      ...
      <div class="uk-container">
        <div class="uk-alert-warning" uk-alert>
          <p>
            <span class="uk-text-bold uk-text-secondary">{PHP.usr.profile.user_name}</span>, you are using the template <code>files.image.tpl</code>
        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 col-sm-2" data-source="folder-file-row-tooltip-{FILES_ROW_ID}" data-toggle="tooltip"
                    ...
                    <a href="{FILES_ROW|cot_filesThumbnailUrl($this,1600,800,'inset')}" rel="" title="{FILES_ROW_TITLE}" class="thumbnail" >
                        <img src="{FILES_ROW|cot_filesThumbnailUrl($this,185,185,'outbound')}" alt="{FILES_ROW_FILENAME}" />
                    </a>
                </div>
...
<div class="row margintop20">
    ...
    <div class="col-xs-4 col-sm-2" data-source="folder-file-row-tooltip-{FILES_ROW_ID}" data-toggle="tooltip"
         title="" data-html="true">
        <a href="{FILES_ROW|cot_filesThumbnailUrl($this,1600,800,'inset', 1, 0)}" rel="" title="{FILES_ROW_TITLE}" class="thumbnail" >
            <img src="{FILES_ROW|cot_filesThumbnailUrl($this,185,185,'outbound')}" alt="{FILES_ROW_FILENAME}" />
        </a>
    </div>
    <div id="folder-file-row-tooltip-{FILES_ROW_ID}" class="hidden">
